...
function NewBooking({ onCreated }) {
  const [f, setF] = useState({ date: new Date().toISOString().slice(0,10), senderName:'', senderPhone:'', senderGst:'', pickupAddress:'', origin:'Guwahati', receiverName:'', receiverPhone:'', receiverGst:'', deliveryAddress:'', destination:'', invoiceNumber:'', packages:1, actualWeight:0, volumetricWeight:0, chargeableWeight:0, freightRate:18, biltyCharge:100, doorDeliveryCharge:0, insurance:0, loadingUnloading:0, otherCharges:0, paymentStatus:'PENDING', paymentMode:'CASH', eta:'', branchCode:'HO' })
